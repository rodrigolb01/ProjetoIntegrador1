...
QT_MOC_LITERAL(1, 6, 16), // "closeStatsWindow"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 26) // "on_pushButton_back_clicked"

    },
    "Stats\0closeStatsWindow\0\0"
...
void Stats::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->closeStatsWindow(); break;
        ...
        {
            using _t = void (Stats::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Stats::closeStatsWindow)) {
                *result = 0;
                return;
            }
        }
